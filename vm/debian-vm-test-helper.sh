...
source /dev/stdin <<<$(curl -fsSL https://git.community-scripts.org/tewalds/ProxmoxVED/raw/branch/main/misc/api.func)
source /dev/stdin <<<$(curl -fsSL https://git.community-scripts.org/tewalds/ProxmoxVED/raw/branch/main/misc/helpers.func)
...
<div align='center'>
  <a href='https://Helper-Scripts.com' target='_blank' rel='noopener noreferrer'>
    <img src='https://git.community-scripts.org/tewalds/ProxmoxVED/raw/branch/main/misc/images/logo-81x112.png' alt='Logo' style='width:81px;height:112px;'/>
  </a>
