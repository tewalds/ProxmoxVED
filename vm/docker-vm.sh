...
source <(curl -fsSL https://git.community-scripts.org/tewalds/ProxmoxVED/raw/branch/main/misc/api.func) 2>/dev/null
source <(curl -fsSL https://git.community-scripts.org/tewalds/ProxmoxVED/raw/branch/main/misc/vm-core.func) 2>/dev/null
source <(curl -fsSL https://git.community-scripts.org/tewalds/ProxmoxVED/raw/branch/main/misc/cloud-init.func) 2>/dev/null || true
load_functions
