...
source <(curl -fsSL https://raw.githubusercontent.com/tewalds/ProxmoxVED/kiwix/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/tewalds/ProxmoxVED/kiwix/misc/tools.func)
...
source <(curl -fsSL https://raw.githubusercontent.com/tewalds/ProxmoxVED/kiwix/misc/tools.func) 2>/dev/null || {
